    ...
    <div class="card-header">
      <div class="row">
        <div class="col-12 text-right">
          <a href="{{ route('admin.topic.index') }}" class="btn btn-info"><i class="fas fa-arrow-left"></i> Quay lại</a>
        </div>
      </div>
    </div>
          ...
          @foreach ($list as $row)
            <tr>
              ...
              <td class="text-center">
                ...
                <a href="{{ route('admin.topic.restore', $args) }}" class="btn btn-success"><i class="fas fa-undo-alt"></i></a>
