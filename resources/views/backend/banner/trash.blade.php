    ...
    <div class="card-header">
      <div class="row">
        <div class="col-12 text-right">
          <a href="{{ route('admin.banner.index') }}" class="btn btn-info"><i class="fas fa-arrow-left"></i> Quay lại</a>
        </div>
      </div>
    </div>
        ...
        <tbody>
          @foreach ($list as $row)
            <tr>
              ...
              <td class="text-center"><img src="{{ asset('images/banners/'.$row->image) }}" style="width: 100px" alt="{{ $row->image }}"></td>
              <td>{{ $row->name }}</td>
              <td>{{ $row->link }}</td>
              <td>{{ $row->position }}</td>
              @php
              ...
              <td class="text-center">
                ...
                <a href="{{ route('admin.banner.restore', $args) }}" class="btn btn-success"><i class="fas fa-undo-alt"></i></a>
